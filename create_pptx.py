...
for i, (heading, items, color) in enumerate(categories):
    ...
    for j, item in enumerate(items):
        ...
        add_text(s, x + Inches(0.3), y + Inches(0.7 + j * (0.25 * lines + 0.35)),
...
add_text(s, Inches(1.3), Inches(6.35), Inches(10.7), Inches(0.6),
         "19 Task Templates:  investigate-bug · review-code · author-requirements-doc · "
         "author-design-doc · plan-implementation · author-pipeline · triage-issues · "
         "author-agent-instructions · extend-library  … and more",
         font_size=13, color=WHITE, alignment=PP_ALIGN.CENTER)

speaker_notes(s,
    "Inventory slide. Emphasize breadth: 6 domain-expert personas, 12 protocols across "
    "3 categories (guardrails that prevent errors, analysis for domain-specific checks, "
    "reasoning for systematic approaches), 9 output format specs, and 19 task templates. "
