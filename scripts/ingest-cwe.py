...
def generate_taxonomy_file(domain_key, cwes, weaknesses, version):
    ...
    lines = [
        ...
        "> (CWE\u2122) maintained by The MITRE Corporation. \u00a9 2006\u2013"
        f"{datetime.now(timezone.utc).year} The MITRE",
        "> Corporation. Used under the CWE Terms of Use.",
        ">",
        "> See THIRD-PARTY-NOTICES.md in the repository root for the full",
        "> license text, or visit:",
